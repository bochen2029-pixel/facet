...
cl %CXXFLAGS% facet.cpp facet_gui.cpp es_client.cpp facets.cpp scan.cpp || exit /b 1
rc /nologo /fo facet.res facet.rc || exit /b 1
link /nologo /SUBSYSTEM:CONSOLE /OUT:facet.exe facet.obj facet_gui.obj es_client.obj facets.obj scan.obj facet.res %LIBS% || exit /b 1
link /nologo /SUBSYSTEM:WINDOWS /ENTRY:wmainCRTStartup /OUT:facetw.exe facet.obj facet_gui.obj es_client.obj facets.obj scan.obj facet.res %LIBS% || exit /b 1
